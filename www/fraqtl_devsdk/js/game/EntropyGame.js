...
class EntropyGame {
  constructor(viewport_width, viewport_height, canvas_width, canvas_height, uiSetupFunctor = null) {
    ...
    document.body.appendChild(this.ui.controls_panel);
  ...
  defaultUIsetup() {
    ...
    // Append the canvas to the quantum and set its position style
    document.body.appendChild(this.ui.canvas.elt);
    document.body.appendChild(toggleButton.elt);
  }
