...
Your job: decide whether Step 2 is O(1) or O(2^k). The deep dive is in the **[Skeptic's Guide](PeqNP_SKEPTICS_GUIDE.md)**.
...
- *The Solution:* Random walks. This repository contains the formal proofs — 90 machine-verified theorems — showing that computation, physics, and information theory are the same thing, and that the brain's "low-precision statistical" approach is not a limitation but the optimal architecture.
...
Or start with the full walk-through: [Skeptic's Guide](PeqNP_SKEPTICS_GUIDE.md)
...
All [90 theorems, sorry-free, no custom axioms](Lean/EGPT_PROOFS_VALIDATION.md) — only Lean's three built-in axioms (`propext`, `Quot.sound`, `Classical.choice`).
...
| [**PeqNP_SKEPTICS_GUIDE.md**](PeqNP_SKEPTICS_GUIDE.md) | Constructive P=NP proof walkthrough |
| [**Lean/RFL_SKEPTICS_GUIDE.md**](Lean/RFL_SKEPTICS_GUIDE.md) | Definitional identity P=NP proof walkthrough |
...
| [**Lean/EGPT_PROOFS_VALIDATION.md**](Lean/EGPT_PROOFS_VALIDATION.md) | Build verification: 90 theorems, sorry-free, axiom inventory |
...
90 theorems. No `sorry`. No custom axioms. Every step machine-verified by Lean's kernel.
