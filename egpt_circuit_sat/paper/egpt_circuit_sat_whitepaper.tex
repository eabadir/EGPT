...
\begin{enumerate}
    ...
    \item \href{https://eabadir.github.io/EGPT/Lean/EGPT/Complexity/Tableau.lean}{\texttt{EGPT/Complexity/Tableau.lean}} --- \texttt{SatisfyingTableau} with polynomial complexity bound; \texttt{constructSatisfyingTableau} for deterministic certificate construction.
...
\begin{itemize}
    ...
    \item \href{https://eabadir.github.io/EGPT/Lean/EGPT/Complexity/Tableau.lean}{\texttt{tableauComplexity\_upper\_bound}} --- Certificate complexity $\leq |\text{clauses}| \times |\text{variables}|$.
