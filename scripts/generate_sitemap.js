...
const PRIORITY_RULES = [
  ...
  { pattern: /egpt_circuit_sat\/index\.html$/, priority: '0.9', freq: 'weekly' },
  { pattern: /egpt_circuit_sat_whitepaper\.pdf$/, priority: '0.8', freq: 'monthly' },
  { pattern: /egpt_circuit_sat\/README\.md$/, priority: '0.8', freq: 'monthly' },
  { pattern: /egpt_circuit_sat\/run_multiseed\.js$/, priority: '0.7', freq: 'monthly' },
  { pattern: /egpt_circuit_sat\/data\//, priority: '0.5', freq: 'monthly' },
